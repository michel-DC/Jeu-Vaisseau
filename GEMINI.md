...
- **File Organization:**
  ...
  - `styles/`: CSS files.
- **Comments:** Avoid writing comments unless specifically requested or for complex logic. Do not edit comments that are separate from the code being changed.
- **Language** Only write in french, always, also the error messages.
